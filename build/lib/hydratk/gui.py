...
from hydratk.tkimport import tk, tkmsg, c_os
...
from hydratk.tooltip import ToolTip
...
class Gui(tk.Tk):
    ...
    def _set_menu_help(self):
        ...
        self._menu_help.add_command(label=self.trn.msg('htk_gui_menu_help_web_tutor'), command=self.help.web_tutor)
        self._menu_help.add_command(label=self.trn.msg('htk_gui_menu_help_web_doc'), command=self.help.web_doc)
    ...
    def _set_editor(self):
        ...
        self._colorizer = Colorizer.get_instance(self)
        self._formatter = Formatter.get_instance(self)
        self._autocompleter = AutoCompleter.get_instance(self)
        self._syntaxchecker = SyntaxChecker.get_instance(self)
    ...
    def _set_help(self):
        ...
        self._help = Help.get_instance(self)
